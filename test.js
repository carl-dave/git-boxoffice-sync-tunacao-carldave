...
assertEqual(price, 37, 'price for 3 tickets after rounding and $10 discount');

const groupPrice = tickets.calculateTicketPrice(5, 15.5);
assertEqual(groupPrice, 60.2, '10% group discount plus $10 discount');

const vipPrice = tickets.calculateTicketPrice(2, 100, 'premium');
assertEqual(vipPrice, 290, '50% VIP surcharge plus $10 discount');
